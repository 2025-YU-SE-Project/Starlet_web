  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
                      bg-white text-neutral-900 w-120 rounded-2xl shadow-2xl p-6">
        <div className="text-xl font-semibold pb-2">대표 별자리</div>
        <div className="text-neutral-600 mb-6">
          {item?.name ? `‘${item.name}’` : "선택한 별자리"}를 대표 별자리로 설정하시겠습니까?
        </div>
