  ...
  return (
    <div className="h-screen w-screen overflow-hidden">
      <div className="flex flex-col text-white items-center w-full h-full overflow-y-auto">
        <span className="text-[23px] mt-[147px]">
          작은 별, 작은 감정의 조각
        </span>
        ...
        <form onSubmit={SignInHandler} className="flex flex-col gap-[25px]">
          ...
          <button
            type="submit"
            className="w-[554px] h-[66px] bg-[#3E33DB] text-[24px] p-3"
          >
            LOGIN
          </button>
        </form>
        <div className="flex items-center mt-[10px]">
          <div className="w-[554px] flex justify-start mt-[10px]">
            <label className="flex items-center gap-[10px] cursor-pointer"></label>
          </div>
        </div>
        ...
        <Link to="/foundpassword" className="font-bold mt-[34px] text-[20px]">
          비밀번호 찾기
        </Link>
        <Link to="/" className="font-bold mt-[20px] text-[20px]">
          HOME
        </Link>
      </div>
    </div>
